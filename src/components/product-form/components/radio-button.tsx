  ...
  return (
    <div className="flex">
      ...
      <label
        ...
        ref={labelRef}
        className={clsx(
          "cursor-pointer border select-none flex flex-col justify-center items-center  border-solid peer-checked:bg-[#2a50fe] peer-checked:text-white peer-checked:border-[#2a50fe] border-black",
